...
$ambil  = $con->query("SELECT * FROM pinjaman WHERE id_pinjaman ='$_GET[id_pinjaman]'");
        ...
        <div class="card border border-primary">
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control" name="nominal" id="nominal" value="<?php echo number_format($pecah['nominal'], 0, ',','.') ?>" onkeypress="return angka(event);" required autofocus> 
                            </div>
                        </div>  
                        <div class="col-md-12">
                            <div class="mb-2">
                                <label class="form-label">Angsuran 6 Bulan</label>
                                <input type="text" class="form-control" name="enam" id="enam" value="<?php echo number_format($pecah['enam'], 0, ',','.') ?>" onkeypress="return angka(event);" required autofocus> 
                            </div>
                        </div>  
                        <div class="col-md-12">
                            <div class="mb-2">
                                <label class="form-label">Angsuran 12 Bulan</label>
                                <input type="text" class="form-control" name="duabelas" id="duabelas" value="<?php echo number_format($pecah['duabelas'], 0, ',','.') ?>" onkeypress="return angka(event);" required autofocus> 
                            </div>
                        </div>  
                        <div class="col-md-12">
                            <div class="mb-2">
                                <label class="form-label">Angsuran 18 Bulan</label>
                                <input type="text" class="form-control" name="delapanbelas" id="delapanbelas" value="<?php echo number_format($pecah['delapanbelas'], 0, ',','.') ?>" onkeypress="return angka(event);" required autofocus> 
                            </div>
                        </div>  
                        <div class="col-md-12">
                            <div class="mb-2">
                                <label class="form-label">Angsuran 24 Bulan</label>
                                <input type="text" class="form-control" name="duaempat" id="duaempat" value="<?php echo number_format($pecah['duaempat'], 0, ',','.') ?>" onkeypress="return angka(event);" required autofocus> 
                            </div>
                        </div>  
                        <div class="col-md-12">
                            <div class="mb-2"> 
                ...
                if (isset($_POST['simpan'])) 
                {
                    ...
                    {
                        $con->query("UPDATE pinjaman SET nominal='$nominal',enam='$enam',duabelas='$duabelas',delapanbelas='$delapanbelas',duaempat='$duaempat' WHERE id_pinjaman='$_GET[id_pinjaman]'"); 
                    } 
