            ...
            <div class="subpage">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td style="font-size: 14px;">Pengajuan Permohonan</td>
                    </tr>  
                    <tr>
                ...
                <table style="width: 100%; border-collapse: collapse;">  
                    <tr>
                        ...
                        <td style="font-size: 10px; border: 1px solid #999; padding: 2px; font-weight: bold;">Tanggal</td>
                        <td style="font-size: 10px; border: 1px solid #999; padding: 2px; font-weight: bold;">Waktu</td>
                        <td style="font-size: 10px; border: 1px solid #999; padding: 2px; font-weight: bold;">Status</td> 
                    </tr> 
                    <?php $nomor=1; ?>
                    <?php $ambil=$con->query("SELECT * FROM permohonan NATURAL JOIN konsumen WHERE tgl_permohonan BETWEEN '$tgl_awal' AND '$tgl_akhir' ORDER BY no_permohonan DESC"); ?>
                    ...
                    <tr>
                        ...
                        <td style="font-size: 10px; border: 1px solid #999; padding: 2px; vertical-align: top;"><?php echo $pecah['waktu_permohonan']; ?></td>    
                        <td style="font-size: 10px; border: 1px solid #999; padding: 2px; vertical-align: top;"><?php echo $pecah['status_permohonan']; ?></td> 
                    </tr>
                    <?php $nomor++; ?>
                    <?php } ?>
                </table>
