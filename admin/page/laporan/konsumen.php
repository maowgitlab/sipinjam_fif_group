            ...
            <div class="subpage">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td style="font-size: 14px;">Konsumen</td>
                    </tr>  
                    <tr>
                ...
                <table style="width: 100%; border-collapse: collapse;">  
                    <tr>
                        ...
                        <td style="font-size: 10px; border: 1px solid #999; padding: 2px; font-weight: bold;">Telp</td>
                    ...
                    <?php $nomor=1; ?>
                    <?php $ambil=$con->query("SELECT * FROM konsumen ORDER BY id_konsumen DESC"); ?>
                    ...
                    <tr>
                        ...
                        <td style="font-size: 10px; border: 1px solid #999; padding: 2px; vertical-align: top;"><?php echo $pecah['nik_konsumen']; ?></td>    
                        <td style="font-size: 10px; border: 1px solid #999; padding: 2px; vertical-align: top;"><?php echo $pecah['nama_konsumen']; ?></td>    
                        <td style="font-size: 10px; border: 1px solid #999; padding: 2px; vertical-align: top;"><?php echo $pecah['tmp_konsumen']; ?>, <?php echo $tgl; ?></td>    
                        <td style="font-size: 10px; border: 1px solid #999; padding: 2px; vertical-align: top;"><?php echo $pecah['telp_konsumen']; ?></td>    
                        <td style="font-size: 10px; border: 1px solid #999; padding: 2px; vertical-align: top;"><?php echo $pecah['email_konsumen']; ?></td>    
                        <td style="font-size: 10px; border: 1px solid #999; padding: 2px; vertical-align: top;"><?php echo $pecah['alamat_konsumen']; ?></td>    
                    </tr>
                    <?php $nomor++; ?>
                    <?php } ?>
                </table>
