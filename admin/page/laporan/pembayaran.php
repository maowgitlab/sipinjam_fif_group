            ...
            <div class="subpage">
                ...
                <table style="width: 100%; border-collapse: collapse;">  
                    <tr>
                        ...
                        <td style="font-size: 10px; border: 1px solid #999; padding: 2px; font-weight: bold;">Tanggal Pembayaran</th> 
                        <td style="font-size: 10px; border: 1px solid #999; padding: 2px; font-weight: bold;">Pembayaran Ke</th> 
                        <td style="font-size: 10px; border: 1px solid #999; padding: 2px; font-weight: bold;">Angsuran</th> 
                    </tr> 
                    <?php $nomor=1; ?>
                    <?php $ambil=$con->query("SELECT * FROM permohonan NATURAL JOIN konsumen NATURAL JOIN permohonan_cair NATURAL JOIN pembayaran WHERE tgl_pembayaran BETWEEN '$tgl_awal' AND '$tgl_akhir' ORDER BY no_permohonan DESC"); ?>
