...
<body>
            ...
            <div class="subpage">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td style="font-size: 14px;">Keterlambatan</td>
                    </tr>   
                    <tr>
    ...
    <tr>
        ...
        <td style="font-size: 10px; border: 1px solid #999; padding: 2px; font-weight: bold;">Tanggal Jatuh Tempo</td>
        <td style="font-size: 10px; border: 1px solid #999; padding: 2px; font-weight: bold;">Selama</td>
    </tr> 
    <?php
        $nomor = 1;
        ...
        <tr>
            ...
            <td style="font-size: 10px; border: 1px solid #999; padding: 2px; vertical-align: top;"><?php echo $jatuh_tempo; ?></td>
            <td style="font-size: 10px; border: 1px solid #999; padding: 2px; vertical-align: top;"><?php echo $selama; ?> Hari</td> 
        </tr>
    <?php
        $nomor++;
    }
