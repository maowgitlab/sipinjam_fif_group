                            ...
                            <table class="table table-borderless table-sm align-middle mb-0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-dark text-end"><a href="../admin/assets/gambar/syarat/<?php echo $pecah['ktp'] ?>" target="_blank">Lihat</a></td>
                                    </tr> 
                                    <tr>
                                        <th class="ps-0" scope="row">Fotocopy Kartu Keluarga</th>
                                        <td class="text-dark text-end"><a href="../admin/assets/gambar/syarat/<?php echo $pecah['kk'] ?>" target="_blank">Lihat</a></td>
                                    </tr> 
                                    <tr>
                                        <th class="ps-0" scope="row">Fotocopy STNK</th>
                                        <td class="text-dark text-end"><a href="../admin/assets/gambar/syarat/<?php echo $pecah['stnk'] ?>" target="_blank">Lihat</a></td>
                                    </tr> 
                                    <tr>
                                        <th class="ps-0" scope="row">Fotocopy BPKB</th>
                                        <td class="text-dark text-end"><a href="../admin/assets/gambar/syarat/<?php echo $pecah['bpkb'] ?>" target="_blank">Lihat</a></td>
                                    </tr> 
                                    <tr>
                                        <th class="ps-0" scope="row">Fotocopy Rekening Listrik</th>
                                        <td class="text-dark text-end"><a href="../admin/assets/gambar/syarat/<?php echo $pecah['listrik'] ?>" target="_blank">Lihat</a></td>
                                    </tr>  
                                    <tr>
                                        <th class="ps-0" scope="row" style="vertical-align: top;">Status Permohonan</th>
                                        <td class="text-dark text-end">
                                            <?php if($pecah['status_permohonan'] == 'Pending'){ ?> 
                                                <span>permohonan pengajuan dana anda sudah kami terima, menunggu petugas lapangan untuk melakukan survey</span>
                                            <?php } ?>

                                            <?php if($pecah['status_permohonan'] == 'Cek, Selesai'){ ?> 
                                                <span>Silahkan datang ketempat kami untuk proses pencairan dana dan pemilihan angsuran</span>
                                            <?php } ?>
                                        </td>
                                    </tr> 
                                </tbody>
